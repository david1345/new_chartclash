-- Upgrade system_settings to use JSONB for flexibility (multipliers, etc)
ALTER TABLE public.system_settings ALTER COLUMN value TYPE JSONB USING to_jsonb(value);

-- Update/Insert required keys for the reward engine
...
-- Re-create RPC to point to system_settings instead of system_configs
...
begin
    ...
    -- 2. Fetch System Configs (Updated to system_settings)
