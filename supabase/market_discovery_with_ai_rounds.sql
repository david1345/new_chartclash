...
BEGIN
    ...
    user_predictions AS (
        -- For user predictions, we still look at currently pending ones if possible, 
        -- but for simplicity in landing page boxes, we'll sync with the AI round or just show active count.
        SELECT
            p.asset_symbol,
            p.timeframe,
