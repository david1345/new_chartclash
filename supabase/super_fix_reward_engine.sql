-- [SUPER FIX] Consolidating System Settings and Advanced Reward Logic
-- 1. Upgrade system_settings and Insert Defaults
...
-- 2. Create the ROBUST resolve_prediction_advanced (Pointing to system_settings)
...
begin
    ...
    -- 2. Fetch System Configs (system_settings)
